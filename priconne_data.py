...
class _PriconneData:
    ...
    CHARA = {
        ...
        1127: ["铃(游骑兵)", "リン(レンジャー)", "Rin(Ranger)","铃(游侠)", "骑兵松鼠", "游侠松鼠", "游骑兵松鼠", "护林员松鼠", "护林松鼠", "游侠🐿️", "武松"],
        1128: ["真阳(游骑兵)", "マヒル(レンジャー)", "Mahiru(Ranger)", "真阳(游侠)","骑兵奶牛", "游侠奶牛", "游骑兵奶牛", "护林员奶牛", "护林奶牛", "游侠🐄", "游侠🐮"],
        ...
        1131: ["流夏(泳装)", "ルカ(サマー)", "Ruka(Summer)", "水流夏", "水大姐头", "水大姐", "泳装大姐头", "泳装流夏", "流夏(夏日)","水亚索","泳装亚索","亚索"],
        ...
        1135: ["美里(夏日)","ミサト","Misato(Summer)", "水圣母","水母","水美里","泳装圣母","泳装美里"],
        ...
        1802: ['优衣(公主)', "ユイ(プリンセス)", "Yui(Princess)", "公主种田", "公主优衣", "掉毛", "飞翼", "飞翼高达", "公田"],
